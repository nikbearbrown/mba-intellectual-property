...
The central argument of **Introduction to Intellectual Property: with LLMs** is that readers need a working method for the part of the work that cannot be delegated: the judgment that decides whether an output is correct, useful, ethical, situated, and worth acting on.
...
- **Chapter 1: Patent Basics.** Patent Basics establishes one part of the book's working method and gives the reader language for using that method in practice.
- **Chapter 2: Patent Enforcement.** Patent Enforcement establishes one part of the book's working method and gives the reader language for using that method in practice.
- **Chapter 3: Copyright Basics.** Copyright Basics establishes one part of the book's working method and gives the reader language for using that method in practice.
- **Chapter 4: Trademark Basics.** Trademark Basics establishes one part of the book's working method and gives the reader language for using that method in practice.
- **Chapter 5: Trade Secret Basics.** Trade Secret Basics establishes one part of the book's working method and gives the reader language for using that method in practice.
...
#introduction #to #intellectual #property #with #llms #AI #education #judgment #Medhavy #Medhavi #intelligent-textbook
